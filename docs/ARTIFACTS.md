...
| Evidence notes | Evidence bundle | `evidence/current/*.md`; `evidence/completed/*.md` | Shows implementation and validation evidence records over time. | Technical reviewer | mixed current/historical | Published by glob in wiki manifest. |
