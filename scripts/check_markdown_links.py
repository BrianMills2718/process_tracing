...
DEFAULT_TARGETS = ("README.md", "CLAUDE.md", "AGENTS.md", "docs/CLAUDE.md", "docs/plans")
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Markdown files or directories to scan (default: README.md CLAUDE.md AGENTS.md docs/CLAUDE.md docs/plans)",
    )
    parser.add_argument(
        "--repo-root",
